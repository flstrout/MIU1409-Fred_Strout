...
/**
 Base class for all CustomerRecovery views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the CustomerRecovery view hierarchy (such as wrapped iOS UIViews) was touched.
