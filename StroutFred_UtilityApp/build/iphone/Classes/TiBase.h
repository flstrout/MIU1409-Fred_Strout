...
// in simulator we redefine to format for CustomerRecovery Developer console
...
{\
	NSString * exceptionName = [@"org.customerrecovery." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.customerrecovery";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UICustomerRecoveryNativeItemNone = -1, 
	UICustomerRecoveryNativeItemSpinner = -2,
	UICustomerRecoveryNativeItemProgressBar = -3,
	
	UICustomerRecoveryNativeItemSlider = -4,
	UICustomerRecoveryNativeItemSwitch = -5,
	UICustomerRecoveryNativeItemMultiButton = -6,
	UICustomerRecoveryNativeItemSegmented = -7,
	
	UICustomerRecoveryNativeItemTextView = -8,
	UICustomerRecoveryNativeItemTextField = -9,
	UICustomerRecoveryNativeItemSearchBar = -10,
	
	UICustomerRecoveryNativeItemPicker = -11,
	UICustomerRecoveryNativeItemDatePicker = -12,
	
	UICustomerRecoveryNativeItemInfoLight = -13,
	UICustomerRecoveryNativeItemInfoDark = -14,
	
	UICustomerRecoveryNativeItemDisclosure = -15,
	
	UICustomerRecoveryNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all CustomerRecovery instances of
