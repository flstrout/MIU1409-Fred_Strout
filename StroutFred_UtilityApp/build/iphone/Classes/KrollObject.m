...
//@interface CustomerRecoveryObject : NSObject
//@end

@interface CustomerRecoveryObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[CustomerRecoveryObject class]])
		{
			for (NSString *key in [[(CustomerRecoveryObject*)o modules] allKeys])
			{
