...
//Rare exceptions to indicate a bug in the _customerrecovery code (Eg, function that a subclass should have implemented)
...
/**
 The base class for CustomerRecovery proxies.
 */
