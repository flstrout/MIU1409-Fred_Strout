...
@interface CustomerRecoveryObject : KrollCoverageObject {
#else
@interface CustomerRecoveryObject : KrollObject {
#endif
@private
...
extern NSString * CustomerRecovery$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	CustomerRecoveryObject *_customerrecovery;
    KrollObject* console;
	BOOL shutdown;
