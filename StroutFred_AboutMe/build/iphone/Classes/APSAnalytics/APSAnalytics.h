 ...
 * to send analytic data that can be viewed on the StroutFred_AboutMe Dashboard.
 *
 * For information on getting started with StroutFred_AboutMe Platform Services,
