...
@interface StroutFred_AboutMeObject : KrollCoverageObject {
#else
@interface StroutFred_AboutMeObject : KrollObject {
#endif
@private
...
extern NSString * StroutFred_AboutMe$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	StroutFred_AboutMeObject *_stroutfred_aboutme;
    KrollObject* console;
	BOOL shutdown;
