...
//@interface StroutFred_AboutMeObject : NSObject
//@end

@interface StroutFred_AboutMeObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[StroutFred_AboutMeObject class]])
		{
			for (NSString *key in [[(StroutFred_AboutMeObject*)o modules] allKeys])
			{
