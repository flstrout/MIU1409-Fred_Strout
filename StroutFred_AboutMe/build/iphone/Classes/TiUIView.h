...
/**
 Base class for all StroutFred_AboutMe views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the StroutFred_AboutMe view hierarchy (such as wrapped iOS UIViews) was touched.
