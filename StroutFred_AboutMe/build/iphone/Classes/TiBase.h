...
// in simulator we redefine to format for StroutFred_AboutMe Developer console
...
{\
	NSString * exceptionName = [@"org.stroutfred_aboutme." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.stroutfred_aboutme";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIStroutFred_AboutMeNativeItemNone = -1, 
	UIStroutFred_AboutMeNativeItemSpinner = -2,
	UIStroutFred_AboutMeNativeItemProgressBar = -3,
	
	UIStroutFred_AboutMeNativeItemSlider = -4,
	UIStroutFred_AboutMeNativeItemSwitch = -5,
	UIStroutFred_AboutMeNativeItemMultiButton = -6,
	UIStroutFred_AboutMeNativeItemSegmented = -7,
	
	UIStroutFred_AboutMeNativeItemTextView = -8,
	UIStroutFred_AboutMeNativeItemTextField = -9,
	UIStroutFred_AboutMeNativeItemSearchBar = -10,
	
	UIStroutFred_AboutMeNativeItemPicker = -11,
	UIStroutFred_AboutMeNativeItemDatePicker = -12,
	
	UIStroutFred_AboutMeNativeItemInfoLight = -13,
	UIStroutFred_AboutMeNativeItemInfoDark = -14,
	
	UIStroutFred_AboutMeNativeItemDisclosure = -15,
	
	UIStroutFred_AboutMeNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all StroutFred_AboutMe instances of
