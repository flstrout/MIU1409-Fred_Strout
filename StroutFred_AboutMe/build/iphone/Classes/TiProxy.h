...
//Rare exceptions to indicate a bug in the _stroutfred_aboutme code (Eg, function that a subclass should have implemented)
...
/**
 The base class for StroutFred_AboutMe proxies.
 */
