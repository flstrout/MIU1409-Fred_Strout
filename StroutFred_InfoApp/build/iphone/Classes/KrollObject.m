...
//@interface StroutFred_InfoAppObject : NSObject
//@end

@interface StroutFred_InfoAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[StroutFred_InfoAppObject class]])
		{
			for (NSString *key in [[(StroutFred_InfoAppObject*)o modules] allKeys])
			{
