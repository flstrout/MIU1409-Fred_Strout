...
@interface StroutFred_InfoAppObject : KrollCoverageObject {
#else
@interface StroutFred_InfoAppObject : KrollObject {
#endif
@private
...
extern NSString * StroutFred_InfoApp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	StroutFred_InfoAppObject *_stroutfred_infoapp;
    KrollObject* console;
	BOOL shutdown;
