...
//Rare exceptions to indicate a bug in the _stroutfred_infoapp code (Eg, function that a subclass should have implemented)
...
/**
 The base class for StroutFred_InfoApp proxies.
 */
