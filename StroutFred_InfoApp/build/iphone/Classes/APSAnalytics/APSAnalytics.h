 ...
 * to send analytic data that can be viewed on the StroutFred_InfoApp Dashboard.
 *
 * For information on getting started with StroutFred_InfoApp Platform Services,
