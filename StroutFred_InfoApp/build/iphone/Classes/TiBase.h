...
// in simulator we redefine to format for StroutFred_InfoApp Developer console
...
{\
	NSString * exceptionName = [@"org.stroutfred_infoapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.stroutfred_infoapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIStroutFred_InfoAppNativeItemNone = -1, 
	UIStroutFred_InfoAppNativeItemSpinner = -2,
	UIStroutFred_InfoAppNativeItemProgressBar = -3,
	
	UIStroutFred_InfoAppNativeItemSlider = -4,
	UIStroutFred_InfoAppNativeItemSwitch = -5,
	UIStroutFred_InfoAppNativeItemMultiButton = -6,
	UIStroutFred_InfoAppNativeItemSegmented = -7,
	
	UIStroutFred_InfoAppNativeItemTextView = -8,
	UIStroutFred_InfoAppNativeItemTextField = -9,
	UIStroutFred_InfoAppNativeItemSearchBar = -10,
	
	UIStroutFred_InfoAppNativeItemPicker = -11,
	UIStroutFred_InfoAppNativeItemDatePicker = -12,
	
	UIStroutFred_InfoAppNativeItemInfoLight = -13,
	UIStroutFred_InfoAppNativeItemInfoDark = -14,
	
	UIStroutFred_InfoAppNativeItemDisclosure = -15,
	
	UIStroutFred_InfoAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all StroutFred_InfoApp instances of
