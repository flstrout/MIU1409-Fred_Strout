...
/**
 Base class for all StroutFred_InfoApp views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the StroutFred_InfoApp view hierarchy (such as wrapped iOS UIViews) was touched.
