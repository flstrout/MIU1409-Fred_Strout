...
// var detailTextData = "Not Working";
...
var jsonData = {
	"Breeds": [
			  ...
			  },
			  {
			    ...
			    "HEIGHT":"8\"-23\"",
			    "COLOR":"Variety of colors",
			    "COAT":"Short and smooth, very dense, very shiny.",
			    "APPEARANCE":"Rat Terriers are lively, muscular dogs that are often described by fanciers as _compact but meaty._ They have strong shoulders, deep chests and muscular legs. The ears of the Rat Terrier are carried erect when alert and can be either tipped or upright when the dog is in repose. The head is wedge shaped and muzzle is strong and slightly shorter than the skull. The nose color should correspond with the color of the coat. The jaw is strong and the teeth should meet in a scissors bite. The tail can either be docked between the second and third joint, or left natural, whether long or bobbed. The tail can be carried in various positions, but should not curl over the back. Rat terriers come in a variety of colors and color combinations, and almost all Rat Terriers have white markings.",
			  ...
			  },
			  {
			    ...
			    "HEIGHT":"8\"-11\"",
			    "COLOR":"Variety of colors",
			    "COAT":"Thick, wooly undercoat, long, abundant topcoat.",
...
var showDetail = function(dataSource){
	...
	// close button
		var closeView = function(e){
			detailWindow.remove(tintView);
			detailWindow.remove(modalView);
		};
		var buttonXout = Ti.UI.createLabel({
			text: "X",
		...
		var buttonClose = Ti.UI.createLabel({
			text: "Close",
			backgroundColor: "#f3f3f4",
			borderColor: "#000065",
			borderRadius: 3,
			borderWidth: 2,
			font: {fontSize: 16, fontFamily: "Helvetica Neue", fontWeight: "bold", fontStyle: "underline"},
			textAlign: "center",
			color: "#000065",
			top: 410,
			left: 80,
		...
		var shadowClose = Ti.UI.createLabel({
			backgroundColor: "#000020",
			borderColor: "#000020",
			borderRadius: 3,
			borderWidth: 2,
			top: buttonClose.top + 3,
			left: 83,
			right: 98,
			width: "140",
			height: "35",
	...
	var selectedImage = dataSource.image2;
	...
	var dataPronunciation = Ti.UI.createLabel({
		text: "(" + dataSource.pronunciation + ")",
		font: {fontSize: 12, fontFamily: "Helvetica Neue"},
		color: "#f3f3f4",
		top: dataBreed.top + 24,
		left: 10,
		right: 5
	});
	
	// Monotonous Code
	// A whole lot of labels: labelName hard coded; dataName written by the for-in loop.
	var labelOrigin = Ti.UI.createLabel({
		text: "Origin:",
		font: {fontSize: 14, fontFamily: "Helvetica Neue"},
		color: "#000065",
		top: dataPronunciation.top + 16,
		left: 8,
		right: 5
	});
	var dataOrigin = Ti.UI.createLabel({
		text: dataSource.origin,
		font: {fontSize: 16, fontFamily: "Helvetica Neue", fontWeight: "bold"},
		color: "#d6ff5f",
		top: labelOrigin.top + 14,
		left: 5,
		right: 5
	});
	var labelLifeSpan = Ti.UI.createLabel({
		text: "Life Span:",
		font: {fontSize: 14, fontFamily: "Helvetica Neue"},
		color: "#000065",
		top: dataOrigin.top + 18,
		left: 8,
		right: 5
	});
	var dataLifeSpan = Ti.UI.createLabel({
		text: dataSource.life,
		font: {fontSize: 16, fontFamily: "Helvetica Neue", fontWeight: "bold"},
		color: "#d6ff5f",
		top: labelLifeSpan.top + 14,
		left: 5,
		right: 5
	});
	var labelHeight = Ti.UI.createLabel({
		...
		font: {fontSize: 14, fontFamily: "Helvetica Neue"},
		color: "#000065",
		top: dataLifeSpan.top + 18,
		left: 8,
		right: 5
	});
	var dataHeight = Ti.UI.createLabel({
		text: dataSource.heightBreed,
		font: {fontSize: 16, fontFamily: "Helvetica Neue", fontWeight: "bold"},
		color: "#d6ff5f",
		top: labelHeight.top + 14,
		left: 5,
		right: 5
	});
	var labelWeight = Ti.UI.createLabel({
		...
		font: {fontSize: 14, fontFamily: "Helvetica Neue"},
		color: "#000065",
		top: dataHeight.top + 18,
		left: 8,
		right: 5
	});
	var dataWeight = Ti.UI.createLabel({
		text: dataSource.weightBreed,
		font: {fontSize: 16, fontFamily: "Helvetica Neue", fontWeight: "bold"},
		color: "#d6ff5f",
		top: labelWeight.top + 14,
		left: 5,
		right: 5
	});
	var labelActivityLevel = Ti.UI.createLabel({
		text: "Activity Level:",
		font: {fontSize: 14, fontFamily: "Helvetica Neue"},
		color: "#000065",
		top: dataWeight.top + 18,
		left: 8,
		right: 5
	});
	var dataActivityLevel = Ti.UI.createLabel({
		text: dataSource.activity,
		font: {fontSize: 16, fontFamily: "Helvetica Neue", fontWeight: "bold"},
		color: "#d6ff5f",
		top: labelActivityLevel.top + 14,
		left: 5,
		right: 5
	});
	var labelTrainability = Ti.UI.createLabel({
		text: "Trainability:",
		font: {fontSize: 14, fontFamily: "Helvetica Neue"},
		color: "#000065",
		top: dataActivityLevel.top + 18,
		left: 8,
		right: 5
	});
	var dataTrainability = Ti.UI.createLabel({
		text: dataSource.trainability,
		font: {fontSize: 16, fontFamily: "Helvetica Neue", fontWeight: "bold"},
		color: "#d6ff5f",
		top: labelTrainability.top + 14,
		left: 5,
		right: 5
	});
	var labelObedience = Ti.UI.createLabel({
		text: "Obedience:",
		font: {fontSize: 14, fontFamily: "Helvetica Neue"},
		color: "#000065",
		top: dataTrainability.top + 18,
		left: 8,
		right: 5
	});
	var dataObedience = Ti.UI.createLabel({
		text: dataSource.obedience,
		font: {fontSize: 16, fontFamily: "Helvetica Neue", fontWeight: "bold"},
		color: "#d6ff5f",
		top: labelObedience.top + 14,
		left: 5,
		right: 5
	});
	var labelColor = Ti.UI.createLabel({
		...
		font: {fontSize: 14, fontFamily: "Helvetica Neue"},
		color: "#000065",
		top: dataObedience.top + 18,
		left: 8,
		right: 5
	});
	var dataColor = Ti.UI.createLabel({
		text: dataSource.colorBreed,
		font: {fontSize: 16, fontFamily: "Helvetica Neue", fontWeight: "bold"},
		color: "#d6ff5f",
		top: labelColor.top + 14,
		left: 5,
		right: 5
	});
	var labelCoat = Ti.UI.createLabel({
		text: "Coat:",
		font: {fontSize: 14, fontFamily: "Helvetica Neue"},
		color: "#000065",
		top: dataColor.top + 18,
		left: 8,
		right: 5
	});
	var dataCoat = Ti.UI.createLabel({
		text: dataSource.coat,
		font: {fontSize: 16, fontFamily: "Helvetica Neue", fontWeight: "bold"},
		color: "#d6ff5f",
		top: labelCoat.top + 14,
		left: 5,
		right: 5
	});
	var labelPersonality = Ti.UI.createLabel({
		text: "Personality:",
		font: {fontSize: 14, fontFamily: "Helvetica Neue"},
		color: "#000065",
		top: dataCoat.top + 40,
	...
	var dataPersonality = Ti.UI.createLabel({
		text: dataSource.personality,
		font: {fontSize: 16, fontFamily: "Helvetica Neue", fontWeight: "bold"},
		color: "#d6ff5f",
		top: labelPersonality.top + 14,
		left: 5,
		right: 5
	});
	...
	var dataGroup = Ti.UI.createLabel({
		text: dataSource.group,
		font: {fontSize: 16, fontFamily: "Helvetica Neue", fontWeight: "bold"},
		color: "#d6ff5f",
		top: labelGroup.top + 14,
		left: 165,
		right: 5
	});
	
// **************************************
// A lot of monotonous code - big gap to make the break easy to find
// **************************************
	
	// Image Slider, Viewer and EventListener
	var imageSlider = Ti.UI.createSlider({
		top:labelActivityLevel.top + 2,
		height: 2,
		width: 185,
		min: 0,
		max: 2,
	...
	/* All events effected by the slider must be encapsulated in its EventListener
	function or at least in a function called by its EventListener function.*/
	
	imageSlider.addEventListener("touchend", function(e){
		this.value = Math.round(e.value);
		
		if (imageSlider.value === 0){
			selectedImage = dataSource.image1;
			} else if (imageSlider.value === 1){
			selectedImage = dataSource.image2;
			} else {
			selectedImage = dataSource.image3;
		};
		
		imageView.image = "images/" + selectedImage;
	});
	
	// More monotonous label code
	var labelGuardAbility = Ti.UI.createLabel({
		text: "Guard Ability:",
		font: {fontSize: 14, fontFamily: "Helvetica Neue"},
		color: "#000065",
		top: labelTrainability.top,
		left: 168,
		right: 5
	});
	
	var dataGuardAbility = Ti.UI.createLabel({
		text: dataSource.guard,
		font: {fontSize: 16, fontFamily: "Helvetica Neue", fontWeight: "bold"},
		color: "#d6ff5f",
		top: labelGuardAbility.top + 14,
		left: 165,
		right: 5
	});
	var labelWatchAbility = Ti.UI.createLabel({
		text: "Watch Ability:",
		font: {fontSize: 14, fontFamily: "Helvetica Neue"},
		color: "#000065",
		top: dataGuardAbility.top + 18,
		left: 168,
		right: 5
	});
	var dataWatchAbility = Ti.UI.createLabel({
		text: dataSource.watch,
		font: {fontSize: 16, fontFamily: "Helvetica Neue", fontWeight: "bold"},
		color: "#d6ff5f",
		top: labelWatchAbility.top + 14,
		left: 165,
		right: 5
	});
...
// **************************************
	...
	// Buttons and Button Shadows
	// Appearance
	var buttonAppearance = Ti.UI.createLabel({
		text: "Appearance",
		backgroundColor: "#f3f3f4",
		borderColor: "#000065",
		borderRadius: 3,
		...
		textAlign: "center",
		color: "#000065",
		top: dataPersonality.top + 45,
		left: 10,
		width: "140",
		height: "35",
		call: dataSource.appearance,
		zIndex: 1
	});
	
	var shadowAppearance = Ti.UI.createLabel({
		backgroundColor: "#000099",
		borderColor: "#000099",
		borderRadius: 3,
		borderWidth: 2,
		top: buttonAppearance.top + 3,
		left: 13,
		width: "140",
		height: "35",
		zIndex: 0
	...
	// Temperament
	var buttonTemperament = Ti.UI.createLabel({
		text: "Temperament",
		backgroundColor: "#f3f3f4",
		borderColor: "#000065",
		borderRadius: 3,
		...
		width: "140",
		height: "35",
		call: dataSource.temperament,
		zIndex: 1
	});
	
	var shadowTemperament = Ti.UI.createLabel({
		backgroundColor: "#000099",
		borderColor: "#000099",
		borderRadius: 3,
		borderWidth: 2,
		top: buttonTemperament.top + 2,
		right: 10,
		width: "140",
		height: "35",
		zIndex: 0
	...
	// Lineage
	var buttonLineage = Ti.UI.createLabel({
		text: "Lineage",
		backgroundColor: "#f3f3f4",
		borderColor: "#000065",
		borderRadius: 3,
		...
		textAlign: "center",
		color: "#000065",
		top: buttonTemperament.top + 45,
		left: 90,
		right: 90,
		width: "140",
		height: "35",
		call: dataSource.lineage,
		zIndex: 1
	});
	
	var shadowLineage = Ti.UI.createLabel({
		backgroundColor: "#000099",
		borderColor: "#000099",
		borderRadius: 3,
		borderWidth: 2,
		top: buttonLineage.top + 3,
		left: 93,
		right: 98,
		width: "140",
		height: "35",
	...
	// Make the buttons do something - openDetail->push call custom property
	buttonAppearance.addEventListener("click", openDetail);
	buttonTemperament.addEventListener("click", openDetail);
	buttonLineage.addEventListener("click", openDetail);
	
	// Write everything to the UI - Display it all
	detailWindow.add(dataBreed,dataPronunciation,labelOrigin,dataOrigin,labelLifeSpan,dataLifeSpan,labelHeight,dataHeight,labelWeight,dataWeight,labelActivityLevel,dataActivityLevel,labelTrainability,dataTrainability,labelColor,dataColor,labelCoat,dataCoat,labelPersonality,dataPersonality,labelGroup,dataGroup,labelObedience,dataObedience,labelGuardAbility,dataGuardAbility,labelWatchAbility,dataWatchAbility,imageView,imageSlider,buttonAppearance,shadowAppearance,buttonTemperament,shadowTemperament,buttonLineage,shadowLineage);
	navWindow.openWindow(detailWindow);
};

// Make the Homepage list
var lists = [];
...
for (o in jsonData.Breeds){ 
	var sectionDetail = Ti.UI.createTableViewRow({
		...
		weightBreed:jsonData.Breeds[o].WEIGHT,
		heightBreed:jsonData.Breeds[o].HEIGHT,
		colorBreed:jsonData.Breeds[o].COLOR,
		...
		image1:jsonData.Breeds[o].IMAGE1,
		image2:jsonData.Breeds[o].IMAGE2,
		image3:jsonData.Breeds[o].IMAGE3,
		hasChild: true,
		backgroundColor: "#eee",
		color: "#000065"
	});
...
// The code for the Sources Button
var openSources = function(){
	var tintViewSources = Ti.UI.createView({
		backgroundColor: "#000",
		opacity: .45,
		zIndex: 2
	});
	
	var modalViewSources = Ti.UI.createView({
		top: 20,
		left: 10,
		height: 460,
		width: 300,
	...
	var text1Sources = Ti.UI.createLabel({
		text: "Data Sources",
		top: 20,
		width: 280,
	...
	var text2Sources = Ti.UI.createLabel({
		text: "www.dogbreedinfo.com\nwww.petwave.com",
		top: 40,
		width: 280,
		font: {fontSize: 14, fontFamily: "Helvetica Neue", fontWeight: "bold"},
		color: "#f3f3f4"
	...
	var text3Sources = Ti.UI.createLabel({
		text: "Image Sources",
		top: 100,
		width: 280,
		font: {fontSize: 18, fontFamily: "Helvetica Neue", fontWeight: "bold"},
	...
	var text4Sources = Ti.UI.createLabel({
		text: "www.dogbreedinfo.com\nwww.petwave.com\nwww.hdbackgroundpoint.com\nwww.dogbreedsites.com\nwww.chihuahuawardrobe.com\nwww.dog-breeds.findthebest.com\nwww.pedigreedatabase.com\nwww.puppydogweb.com\nwww.dogfactsforkids.com\nwww.fanshare.com\nwww.dogbreedplus.com",
		top: 120,
		width: 280,
		font: {fontSize: 14, fontFamily: "Helvetica Neue", fontWeight: "bold"},
		color: "#f3f3f4"
	...
	// close button
		var closeView = function(e){
			tableWindow.remove(tintViewSources);
			tableWindow.remove(modalViewSources);
		};
		var buttonXoutSources = Ti.UI.createLabel({
			text: "X",
			font: {fontSize: 11, fontFamily: "Arial", fontWeight: "bold"},
			textAlign: "center",
			color: "#f3f3f4",
		...
		var buttonCloseSources = Ti.UI.createLabel({
			text: "Close",
			backgroundColor: "#f3f3f4",
			borderColor: "#000065",
			borderRadius: 3,
		...
		var shadowCloseSources = Ti.UI.createLabel({
			backgroundColor: "#000020",
			borderColor: "#000020",
			borderRadius: 3,
			borderWidth: 2,
			top: buttonCloseSources.top + 3,
			left: 83,
			right: 98,
			width: "140",
			height: "35",
		...
		buttonCloseSources.addEventListener("click", closeView);
		buttonXoutSources.addEventListener("click", closeView);
		
	// Write everything to the UI - Display it all
	modalViewSources.add(text1Sources,text2Sources,text3Sources,text4Sources,buttonXoutSources,buttonCloseSources,shadowCloseSources);
	tableWindow.add(tintViewSources,modalViewSources);
};

// Create the Sources Button on the Homepage and point it to the code that makes it do something
var buttonSources = Ti.UI.createButton({
	title: "Sources",
	top: 460,
	borderColor: "#000065",
	borderRadius: 15,
...
buttonSources.addEventListener("click", openSources);

// Created By Label
var createdBy = Ti.UI.createLabel({
	text: "Created By: Fred Strout / MIU-1409",
	font: {fontSize: 9, fontFamily: "Helvetica Neue"},
	color: "#000065",
	top: 335
});

breeds.setData(lists);
breeds.addEventListener("click", function(event){
	showDetail(event.source);
});

tableWindow.add(breeds,createdBy,buttonSources);