	...
	"Breeds": [
			  {
			    ...
			    "ORIGIN":"Germany",
			    "PERSONALLITY":"Loyal, protective, serious and fearless",
			    "WEIGHT":"85-130 lbs.",
			    "HEIGHT":"22\"-27\"",
			  ...
			  },
			  {
			    ...
			    "LIFE SPAN":"15+ years",
			    "ORIGIN":"Mexico",
			    "PERSONALLITY":"Varied, ranging from shy and timid to plucky and outgoing",
			    "WEIGHT":"2-6 lbs.",
			    "HEIGHT":"6\"-9\"",
			  ...
			  },
			  {
			    ...
			    "ORIGIN":"England",
			    "PERSONALLITY":"High energy dogs who love to be _at work,_ chasing, digging for and killing pests",
			    "WEIGHT":"4-35 lbs.",
			    "HEIGHT":"8\"-23\"",
			    "COLOR":"Variety of colors",
			  ...
			  },
			  {
			    ...
			    "ORIGIN":"England",
			    "PERSONALLITY":"Fearless, bossy, dynamic, intelligent and lively",
			    "WEIGHT":"7 lbs.",
			    "HEIGHT":"6\"-7\"",
			  ...
			  },
			  {
			    ...
			    "LIFE SPAN":"15+ years",
			    "ORIGIN":"China",
			    "PERSONALLITY":"Alert, lively, gentle, loyal, happy and hardy",
			    "WEIGHT":"9-16 lbs.",
			    "HEIGHT":"8\"-11\"",
			    "COLOR":"Variety of colors",
...
//for (var n in jsonData){ 
	...
	for (o in jsonData.Breeds){ 
		var sectionDetail = Ti.UI.createTableViewRow({
			...
			title: jsonData.Breeds[o].BREED,
			detail: jsonData.Breeds[o].PRONUNCIATION,
			hasChild: true,
			backgroundColor: "#eee",
			color: "#014421"
		});
